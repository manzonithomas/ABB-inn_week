...
<div class="pub-container">
    ...
    <?php if ($data['taratura_id']): ?>
        ...
        <div class="info-card">
            ...
            <div class="info-grid">
                ...
                <div class="info-item">
                    ...
                    <div class="info-val" style="color:<?= $stato === 'scaduta' ? '#FF000F' : ($stato === 'in_scadenza' ? '#f57f17' : 'inherit') ?>; font-weight:700;">
                ...
                <div class="info-item">
                    ...
                    <div class="info-val">
                        <span class="esito-pill <?= $data['esito'] === 'conforme' ? 'esito-conforme' : 'esito-non-conforme' ?>">
        ...
        <?php if ($data['pdf_path']): ?>
            <a href="<?= BASE_URL ?>/<?= e($data['pdf_path']) ?>"
               target="_blank" class="btn-pdf" style="margin-bottom:12px; display:flex;">
    ...
    <!-- Link storico -->
    <a href="<?= BASE_URL ?>/public/reparto.php?reparto=<?= urlencode($data['reparto']) ?>"
       class="storico-link">
